...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ARROWS,   KC_A,     ALT_HL,   GUI_HL, CTL_HL,  KC_I,                   KC_D,    CTL_HR,  GUI_HR,  ALT_HR,  KC_S,    KC_MINS,
    ...
    [_LOWER] = LAYOUT(
		KC_GRV,   KC_1,    KC_QUOT, KC_DQT,  KC_GRV,  KC_5,                    KC_6,    KC_UNDS, KC_MINS, KC_SLSH, KC_BSLS, KC_BSLS, KC_EQL,
    ...
    [_RAISE] = LAYOUT(
		...
		KC_TRNS,  KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_TRNS,       KC_TRNS, SRCHPWD, SCRNLYR, VIMWIND, SPCP,    SPCN,    KC_TRNS,
    ...
    [_ADJUST] = LAYOUT(
		...
		GAME,    _______,   ALT_L,   KC_DOWN, ALT_R,   _______,                _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______,
    ...
    [_ARROWS] = LAYOUT(
		...
		_______, KC_LSFT,   KC_LALT, KC_LGUI, KC_LCTL, KC_END ,                KC_PGDN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RGHT,
		TAP_CTL, KC_END ,   _______, KC_DOWN, KC_UP,   KC_HOME,       _______, _______, _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS,
		KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS,                            KC_TRNS, KC_TRNS
    ),
    [_GAME] = LAYOUT(
		_______, _______,   KC_Q,    KC_W,    KC_E,    KC_HOME,                KC_PGUP, KC_G,    KC_UP,   KC_UP,   KC_RGHT, KC_RGHT, KC_RGHT,
		KC_TAB,  KC_LCTL,   KC_A,    KC_S,    KC_D,    KC_END ,                KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_RGHT, KC_RGHT,
		TAP_CTL, KC_END ,   _______, KC_DOWN, KC_UP,   KC_HOME,       _______, _______, _______, _______, _______, _______, KC_TRNS,
		EXT_GME, KC_TRNS,                     KC_TRNS, KC_TRNS,       KC_TRNS, KC_TRNS,                            KC_TRNS, KC_TRNS
    ),
#ifdef STENO_ENABLE
    [_PLOVER] = LAYOUT(
